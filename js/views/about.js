...
export function renderAbout() {
  return '<div class="fade">'
    ...
    + '<p class="portfolio-eyebrow">My Portfolio</p><h1 class="name-pop">Julia Nieto</h1>'
    ...
    + '<section class="about-sec" style="padding-top:52px"><p class="label">Education</p><h2 class="tl-title">Education — <em>most recent first</em></h2>'
